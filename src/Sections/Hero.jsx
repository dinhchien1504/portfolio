    ...
    <section className="min-h-screen w-full flex flex-col relative" id="home">
      <div className=" mx-auto flex flex-col sm:mt-36 mt-20 c-space gap-3">
        <h1
          className="
    animate-typing 
    overflow-hidden whitespace-nowrap border-r-4 border-r-white pr-5 
    text-5xl text-white font-bold text-center"
        >
          Hi, I'm Chien
        </h1>
        
      </div>
      <p className="animate-fadeInUp hero_tag text-gray_gradient text-center">

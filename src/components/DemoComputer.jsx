...
import pj1 from "../public/textures/project/project1.mp4"

const DemoComputer = (props) =>{
    const texture = useVideoTexture(props.txt? props.txt : pj1)
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        >
        <meshBasicMaterial  map={texture} rotation={[-Math.PI, 0, 0]}/>
